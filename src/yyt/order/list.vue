<template>
    <section class="plr-sm">
        ...
        <el-tabs v-model="search.status" @tab-click="getOrderList(true)">
            ...
            <el-row class="order__item" v-for="order in orderList">
                <el-col :span="24">
                    <el-row class="order__product">
                        ...
                        <el-col class="text-success order__price" :span="3">
                            <span>{{((order.totalPrice||0)/100).toFixed(2)}}</span>
                ...
                <el-col class="item__info" :span="24">
                    <el-row class="y-center">
                        ...
                        <el-col :span="9" v-if="order.pickType == 2">电话：{{order.phone}}</el-col>
                        <el-col :span="6" v-if="order.pickType == 1">取货方式：到店自取</el-col>
                        <el-col :span="6" v-if="order.pickType == 2">地址：{{order.address}}</el-col>
        ...
        <div v-if="orderList.length" class="text-center p-sm">
            <el-pagination
                    @current-change="getOrderList(false)"
